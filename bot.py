...
while True:
    try:
        ...
        while b < 10000 :
            time.sleep(1)
            JWT_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiMHgwN2ZEMTYzNDRGODY0Y0VjMGUzMDg4MDMzMTQ4Mjc5MjU1RWJkRTg3Iiwicm9sZSI6InVzZXJfcm9sZSIsImF1ZCI6InBvc3RncmFwaGlsZSIsImlhdCI6MTY3NzA1NDc3MH0.hUWWwB9rzxA8bvWAZa67VDf4zWLQt06PFt3vz24dChs'
